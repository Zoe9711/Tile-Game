...
public class QuickSort {
    ...
    public static <Item extends Comparable> Queue<Item> quickSort(
        ...
        QuickSort.partition(items, QuickSort.getRandomItem(items), less, equal, greater);
        less = QuickSort.quickSort(less);
        greater = QuickSort.quickSort(greater);
        Queue<Item> temp = QuickSort.catenate(less, equal);
        Queue<Item> resultQ = QuickSort.catenate(temp, greater);
        return resultQ;
    }
}
